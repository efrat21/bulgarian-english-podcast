...
📌 Team update (2026-04-28T103000Z): Issue #26 CLOSED — RSS server disconnect resilience complete. Client-aborted writes during file transfer now treated as expected network noise. Dedicated RSS handler intercepts socket write errors while re-raising unrelated OSError failures. Regression tests cover swallow-vs-reraise split; manual pressure test passed. Implemented by Bishop, approved by Lambert.
